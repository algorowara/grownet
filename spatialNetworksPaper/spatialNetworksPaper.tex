...
As dimension increases the nodes have more ways to move around each other, this freedom allows nodes to rearrange their relative positions, thus reducing the possible number of closed triangles of nodes.
